...
module.exports = {
    up: async (queryInterface, Sequelize) => {
      const recipesData = [
        ...
        { title: 'BBQ Pulled Pork Sandwich', ingredients: 'Pork shoulder, BBQ sauce, buns', instructions: 'Slow cook pork shoulder, shred, and mix with BBQ sauce. Serve on buns.', categoryId: 4, createdAt: new Date(), updatedAt: new Date() }, { title: 'Spaghetti Bolognese', ingredients: 'Ground beef, tomatoes, pasta', instructions: 'Cook ground beef, add tomatoes, serve over pasta.', categoryId: 6, createdAt: new Date(), updatedAt: new Date() },
